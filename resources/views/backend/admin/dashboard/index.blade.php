@extends('layouts.app')
@section('title', session()->has('bahasa') ? GoogleTranslate::trans("Dashboard | TrucKu Borneo",
session()->get('bahasa')) : GoogleTranslate::trans("Dashboard | TrucKu Borneo", 'id'))
@section('content')
<div class="container-fluid">
    <div class="form-head d-flex align-items-center mb-sm-4 mb-3">
        <div class="mr-auto">
            <h2 class="text-black font-w600">{{ session()->has('bahasa') ? GoogleTranslate::trans("Dashboard",
                session()->get('bahasa')) : GoogleTranslate::trans("Dashboard", 'id') }}</h2>
                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            ...
                            <span>{{ session()->has('bahasa') ? GoogleTranslate::trans("Costumer",
                                session()->get('bahasa')) : GoogleTranslate::trans("Costumer", 'id') }}</span>
                        </div>
                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            ...
                            <span>{{ session()->has('bahasa') ? GoogleTranslate::trans("Truk",
                                session()->get('bahasa')) : GoogleTranslate::trans("Truk", 'id') }}</span>
                        </div>
                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            ...
                            <span>{{ session()->has('bahasa') ? GoogleTranslate::trans("Sopir",
                                session()->get('bahasa')) : GoogleTranslate::trans("Sopir", 'id') }}</span>
                        </div>
                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="40"
                            height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            ...
                            <span>{{ session()->has('bahasa') ? GoogleTranslate::trans("Transaksi",
                                session()->get('bahasa')) : GoogleTranslate::trans("Transaksi", 'id') }}</span>
                        </div>
